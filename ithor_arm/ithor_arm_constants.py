...
ALL_POSSIBLE_OBJECTS = ['ButterKnife', 'Sink', 'GarbageCan', 'Plate', 'PepperShaker', 'Cup', 'Mug', 'CoffeeMachine', 'Knife', 'Spatula', 'Pan', 'Egg', 'Pot', 'Toaster', 'DishSponge', 'Potato', 'Spoon', 'Apple', 'Bread', 'Fork', 'Faucet', 'StoveBurner', 'Lettuce', 'SoapBottle', 'Bowl', 'SaltShaker', 'Tomato']
