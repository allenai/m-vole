...
class SimpleModelWAgentRelativeLocation(ActorCriticModel[CategoricalDistr]):
    ...
    def forward(  # type:ignore
        ...
        agent_relative_location = observations['agent_relative_location']


        agent_relative_location_embedding = self.pointnav_embedding(agent_relative_location)

        visual_observation_encoding = torch.cat([visual_observation_encoding, query_objects, agent_relative_location_embedding], dim=-1)
