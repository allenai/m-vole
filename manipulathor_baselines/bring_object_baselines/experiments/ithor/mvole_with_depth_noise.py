...
from ithor_arm.mvole_sensors import PointNavEmulatorSensor, NoisyDepthSensorThor
...
class mVOLEwDepthNoise(
    ...
    def train_task_sampler_args(self, **kwargs):
        sampler_args = super(mVOLEwDepthNoise, self).train_task_sampler_args(**kwargs)
    ...
    def test_task_sampler_args(self, **kwargs):
        sampler_args = super(mVOLEwDepthNoise, self).test_task_sampler_args(**kwargs)
        if platform.system() == "Darwin":
            pass
        else:
