...
from ithor_arm.mvole_sensors import PointNavEmulatorSensor
...
class mVOLEwGTMask(
    ...
    def train_task_sampler_args(self, **kwargs):
        sampler_args = super(mVOLEwGTMask, self).train_task_sampler_args(**kwargs)
    ...
    def test_task_sampler_args(self, **kwargs):
        sampler_args = super(mVOLEwGTMask, self).test_task_sampler_args(**kwargs)
        if platform.system() == "Darwin":
            pass
        else:
