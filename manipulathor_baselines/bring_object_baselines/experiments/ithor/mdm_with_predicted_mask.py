...
from ithor_arm.bring_object_sensors import CategorySampleSensor, NoisyObjectMask, NoGripperRGBSensorThor, \
    ObjectCategorySensor, CategoryFeatureSampleSensor, DepthSensorThor, PickedUpObjSensor
from ithor_arm.bring_object_task_samplers import DiverseBringObjectTaskSampler
from ithor_arm.ithor_arm_constants import ENV_ARGS, TRAIN_OBJECTS, TEST_OBJECTS
from ithor_arm.mvole_sensors import PredictionObjectMask
from manipulathor_baselines.bring_object_baselines.experiments.bring_object_mixin_ddppo import BringObjectMixInPPOConfig
from manipulathor_baselines.bring_object_baselines.experiments.bring_object_mixin_simplegru import BringObjectMixInSimpleGRUConfig
from manipulathor_baselines.bring_object_baselines.experiments.ithor.bring_object_ithor_base import BringObjectiThorBaseConfig
from manipulathor_baselines.bring_object_baselines.models.predict_simple_model import PredictMaskSmallBringObjectWQueryObjRGBDModel


class MDMwPredictedMask(
    ...
    def test_task_sampler_args(self, **kwargs):
        sampler_args = super(MDMwPredictedMask, self).test_task_sampler_args(**kwargs)
    ...
    def train_task_sampler_args(self, **kwargs):
        sampler_args = super(MDMwPredictedMask, self).train_task_sampler_args(**kwargs)
        if platform.system() == "Darwin":
            pass
        else:
